...
class PejabatwilayahPreviewDataTable extends DataTable
{
    protected $wilayah;
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->editColumn('foto', function ($data) {
            ...
            ->addColumn('action', 'pejabatwilayahs.datatables_actions_preview')
    ...
    {
        return $model->newQuery()->where('id_wilayah', $this->wilayah)->with('jabatan');
    }
    ...
    protected function getColumns()
    {
        return [
            ...
            'jabatan.nama' => ['name' => 'jabatan.nama', 'data' => 'jabatan.nama', 'title' => 'Jabatan', 'orderable' => false, 'searchable' => false],
            'nama_lengkap',
            'periode'
        ];
    }
