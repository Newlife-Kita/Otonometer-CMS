...
class JabatanDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->editColumn('tipe_wilayah', function ($data) {
            if ($data->tipe_wilayah == 'propinsi') return 'Propinsi';
            elseif ($data->tipe_wilayah == 'kabupaten')  return 'Kabupaten';
            else return 'Kota';
