...
class DataranDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->editColumn('icon_light_mode', function ($data) {
            ...
            ->addColumn('action', 'datarans.datatables_actions')
     ...
     */
    public function query(Dataran $model)
    {
            ...
            ->parameters([
                ...
                'initComplete' => "function() {
                    this.api().columns().every(function() {
                        ...
                        if($(column.header()).attr('title') !== 'Action' && $(column.header()).attr('title') !== 'Icon'){
    ...
    {
        return 'dataransdatatable_' . time();
    }
}
