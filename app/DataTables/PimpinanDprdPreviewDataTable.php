...
class PimpinanDprdPreviewDataTable extends DataTable
{
    protected $wilayah;
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->editColumn('foto', function ($data) {
            ...
            ->addColumn('action', 'pimpinandprds.datatables_action_preview')
    ...
    public function query(DprdTemp $model)
    {
        ...
        return $model->newQuery()->with('masterPartai')->with('masterJabatan')
