...
class DprdDataTable extends DataTable
{
    private $wilayah;
    private $jabatan;
    private $halaman;
    ...
    public function dataTable($query)
    {
        ...
        if($this->halaman == 'pimpinan') $action_view = 'admin_panel.dprd.datatables_actions_pimpinan';
        else $action_view = 'admin_panel.dprd.datatables_actions';
        ...
        ->addColumn('action', $action_view)
        ->rawColumns(['foto', 'nama_lengkap', 'action']);
    }
    ...
    public function query(Dprd $model)
    {
        ...
        ->where('dprd.id_wilayah', $id_wilayah->id)
