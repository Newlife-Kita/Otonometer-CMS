...
class BidangnilaiDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        })->addColumn('action', 'bidangnilais.ekonomi.datatables_actions');
    }
     ...
     */
    public function query(Bidangekonomi $model)
    {
        return $model->newQuery()->select('nomenklatur_amount_ekonomi.id','nomenklatur_amount_ekonomi.kode','nomenklatur_amount_ekonomi.id_wilayah','nomenklatur_amount_ekonomi.id_bidang','nomenklatur_amount_ekonomi.created_at','nomenklatur_amount_ekonomi.nilai')->with('bidang:id,kode,nama')->with('wilayah:id,kode,nama');
    }
    ...
    {
        return [
            'kode' => ['name' => 'kode', 'data' => 'kode', 'title' => 'Kode (Upload Data)'],
