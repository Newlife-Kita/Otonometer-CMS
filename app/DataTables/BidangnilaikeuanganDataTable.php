...
class BidangnilaikeuanganDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        })->addColumn('action', 'bidangnilais.keuangan.datatables_actions');
    }
     ...
     */
    public function query(Bidangkeuangan $model)
    {
        return $model->newQuery()->select('nomenklatur_amount_keuangan.id','nomenklatur_amount_keuangan.kode','nomenklatur_amount_keuangan.id_wilayah','nomenklatur_amount_keuangan.id_bidang','nomenklatur_amount_keuangan.created_at','nomenklatur_amount_keuangan.nilai')->with('bidang:id,kode,nama')->with('wilayah:id,kode,nama');
    }
