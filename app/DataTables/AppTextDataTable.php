...
class AppTextDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        })->addColumn('action', 'app_texts.page.datatables_actions')->rawColumns(['image','action']);
    }
    ...
    {
        return $model->newQuery()->where('type', 'page')->whereNull('parent_node_id');
    }
