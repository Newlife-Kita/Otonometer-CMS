...
class AppStructureDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        })->addColumn('action', 'app_structures.datatables_actions')->rawColumns(['image','action']);;
    }
    ...
    {
        return $model->newQuery()->where('type', 'page');
    }
