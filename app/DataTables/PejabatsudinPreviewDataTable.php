...
class PejabatsudinPreviewDataTable extends DataTable
{
    protected $sudin;
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->editColumn('foto', function ($data) {
            ...
            ->addColumn('action', 'sudins.datatables_actions_pejabat_sudin_preview')
     ...
     */
    public function query(PejabatsudinTemp $model)
    {
