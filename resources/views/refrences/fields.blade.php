...
{{-- <div class="form-group col-sm-12 col-lg-12">
    ...
    {!! Form::textarea('name', null, ['class' => 'form-control my-editor']) !!}
</div> --}}

<div class="form-group col-sm-10">
    {!! Form::label('name', 'Nama:', ['class' => 'd-block']) !!}
    @foreach($bahasa as $lg)
        ...
        <div class="input-group">
            ...
            {!! Form::text('name['.$lg->code.']', (!empty($refrence->name) ? $refrence->getTranslation('name', $lg->code) : null), ['class' => 'form-control', 'required']) !!}
        </div>
    @endforeach
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('refrences.index') !!}" class="btn btn-light">Cancel</a>
</div>
