        ...
        <div class="container">
            ...
            <div style="margin-right: -15px;margin-left: -15px;">
                <div data-label="Edit" class="df-example demo-forms services-forms">
                    {!! Form::model($pejabat, ['route' => ['panel.pejabat_sudins.update', $pejabat->id], 'method' => 'patch', 'files' => true]) !!}
                    <div class="row">
                        <div class="col-sm-12">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-5">
                                            ...
                                            {!! Form::select('id_suku_dinas', @$sukudinas, $pejabat->id_suku_dinas, ['class' => 'form-control select2',
                                            'required']) !!}
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group col-sm-10">
                                                ...
                                                {!! Form::text('nip', @$pejabat->nip, ['class' => 'form-control']) !!}
                                            </div>
                                            ...
                                            <div class="form-group col-sm-10">
                                                ...
                                                <div class="input-group mg-b-10">
                                                    ...
                                                    {!! Form::number('contact', @$pejabat->contact, ['class' => 'form-control']) !!}
                                                </div>
                                            </div>
