        ...
        <div class="container">
            ...
            <div style="margin-right: -15px;margin-left: -15px;">
                <div data-label="Edit" class="df-example demo-forms services-forms">
                    {!! Form::model($sudin, ['route' => ['panel.sudins.update', $sudin->id], 'method' => 'patch']) !!}
                    <div class="row">
                        <div class="col-sm-8">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <div class="input-group mg-t-20">
                                                ...
                                                {!! Form::text('alamat', @$sudin->alamat, ['class' => 'form-control']) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group col-sm-12">
                                        <div class="input-group">
                                            ...
                                            {!! Form::text('telp_pic', @$sudin->telp_pic, ['class' => 'form-control', 'id' => 'telp_pic']) !!}
                                        </div>
                                    </div>
