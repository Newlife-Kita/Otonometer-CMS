        ...
        <div class="container">
            ...
            <div style="margin-right: -15px;margin-left: -15px;">
                <div data-label="Edit" class="df-example demo-forms services-forms">
                    {!! Form::open(['route' => $routes_action, 'files' => true]) !!}
                    <div class="row">
                        <div class="col-sm-12">                                                      
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group col-sm-10">
                                                ...
                                                {!! Form::select('id_partai', $partai, null, [
                                                    'class' => 'form-control select2',
                                                    'required',
                                            ...
                                            @if($page == 'anggota')
                                                ...
                                                <div class="form-group col-sm-10">
                                                    ...
                                                    {!! Form::select('id_komisi', $komisi, null, [
                                                        'class' => 'form-control select2',
                                                        'required',
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div class="form-group col-sm-12">
                                                ...
                                                <div class="input-group mg-b-10">
                                                    ...
                                                    {!! Form::number('tahun_akhir', date('Y')+4, [
                                                        'class' => 'form-control date',
                                                        'required',
                                                        'min' => '1945',
                                                        'max' => date('Y')+4,
                                            ...
                                            <div class="form-group col-sm-12">
                                                <div class="input-group mg-b-10">
                                                    ...
                                                    <div class="mg-l-10">
                                                        <button type="button" class="btn btn-xs btn-outline-info btn-icon wd-30 rounded-pill" id="popup-tahun" data-html="true" title="Tahun Jabatan" data-content="<img class='wd-100p' src='{{ asset('popup-image-tahun-dprd.jpg') }}'><span class='tx-center d-block mg-t-5'>Tahun Jabatan adalah pencarian pejabat pada saat filter tahun dipilih pada aplikasi/website</span>"><i class="fas fa-info"></i></button>
                                                    </div>
                                                </div>
