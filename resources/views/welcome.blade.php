        ...
        <div class="flex-center position-ref full-height">
            ...
            <div class="content">
                <div class="d-flex align-items-center flex-column">
                    <img src="{{ asset('otonometer.png') }}" alt="Otonometer" class="d-block wd-80p align-self-center" />
                    <img src="{{ asset('neraca_ruang.png') }}" alt="Neraca Ruang" class="d-block wd-30p align-self-center" />
                </div>
