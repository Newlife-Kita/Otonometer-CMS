...
<div class="form-group col-sm-10 col-lg-10">
    ...
    {!! Form::text('title', null, ['class' => 'form-control my-editor']) !!}
</div>
...
<div class="form-group col-sm-10 col-lg-10">
    ...
    {!! Form::text('key', null, ['class' => 'form-control my-editor']) !!}
</div>
...
{{-- <div class="form-group col-sm-12 col-lg-12">
    ...
    {!! Form::textarea('value', null, ['class' => 'form-control my-editor']) !!}
</div> --}}
...
<div class="form-group col-sm-12">
    ...
    @foreach($bahasa as $lg)
        ...
        <div class="input-group">
            ...
            {!! Form::textarea('value['.$lg->code.']', (!empty($setting->value) ? $setting->getTranslation('value', $lg->code) : null), ['class' => 'form-control my-editor']) !!}
        </div>
    @endforeach
</div>
...
<div class="form-group col-sm-12">
    ...
    @foreach($bahasa as $lg)
        ...
        <div class="input-group">
            ...
            {!! Form::textarea('description['.$lg->code.']', (!empty($setting->description) ? $setting->getTranslation('description', $lg->code) : null), ['class' => 'form-control my-editor']) !!}
        </div>
    @endforeach
</div>
...
<div class="form-group col-sm-10 col-lg-10">
    ...
    {!! Form::text('type', null, ['class' => 'form-control my-editor']) !!}
</div>
