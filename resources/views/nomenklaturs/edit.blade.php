...
@section('contents')
    <div class="content content-components">
        <div class="container">
            ...
            <div class="forms">
                {!! Form::model($nomenklatur, ['route' => ['nomenklaturs.update', $nomenklatur->id], 'method' => 'patch']) !!}      
                    <!-- Tahun Field -->
                    <div class="form-group col-sm-2 col-lg-2">                              
                        {!! Form::label('tahun_nomenklatur', 'Tahun Nomenklatur:', ['class' => 'd-block']) !!}                            
                        <div class="input-group">
                            {!! Form::text('tahun_nomenklatur', @$nomenklatur->kode, ['class' => 'form-control', 'required', 'placeholder' => 'yyyy', 'id' => 'tahun_nomenklatur']) !!}
                            <div class="input-group-append append-box"></div>
                        </div>
                    </div> 
                    <div class="form-group col-sm-6 col-lg-6">                              
                        {!! Form::label('description', 'Deskripsi:', ['class' => 'd-block']) !!}                            
                        {!! Form::text('description', @$nomenklatur->description, ['class' => 'form-control', 'required', 'placeholder' => 'Deskripsi']) !!}
                    </div>    
                    <hr> 
                                ...
                                <tr class="{{ $bid["cls_str"] }}">
                                    ...
                                    <td>
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            {!! Form::checkbox('use_row[]', $bid['id'], 
                                            in_array($nomenklatur->kode, $bid['tahun_arr']) ? true : false, ['class' => 'custom-control-input check-used-keuangan','id' => 'check_keuangan_'.$bid['id']]) !!}
                            ...
                            <tbody class="tbody-ekonomi">                    
                                ...
                                <tr class="{{ $bid["cls_str"] }}">
                                    ...
                                    <td>
                                        <div class="custom-control custom-checkbox">
                                            {!! Form::hidden('year_row['.$bid['id'].']', $bid['tahun']) !!}
                                            {!! Form::checkbox('use_row[]', $bid['id'], in_array($nomenklatur->kode, $bid['tahun_arr']) ? true : false, ['class' => 'custom-control-input check-used-ekonomi','id' => 'check_ekonomi_'.$bid['id']]) !!}
                            ...
                            <tbody class="tbody-statistik">          
                                ...
                                <tr class="{{ $bid["cls_str"] }}">
                                    ...
                                    <td>
                                        <div class="custom-control custom-checkbox">
                                            {!! Form::hidden('year_row['.$bid['id'].']', $bid['tahun']) !!}
                                            {!! Form::checkbox('use_row[]', $bid['id'], in_array($nomenklatur->kode, $bid['tahun_arr']) ? true : false, ['class' => 'custom-control-input check-used-statistik','id' => 'check_statistik_'.$bid['id']]) !!}
