<div class="row">
    <div class="col-sm-6">
        <div class="form-group col-sm-10">
            {!! Form::label('version_number', 'Version:') !!}
            {!! Form::text('version_number', null, ['class' => 'form-control']) !!}
        </div>

        <div class="form-group col-sm-10">
            {!! Form::label('platform', 'Platform:') !!}
            {!! Form::select('platform', ['android' => 'Android', 'apple' => 'Apple'], @$version->platform ? $version->platform : 'android', [
        ...
        <div class="form-group col-sm-10">
            {!! Form::label('force_update', 'Paksa Update:') !!}
            {!! Form::select('force_update', [1 => 'Ya', 0 => 'Tidak'],  !is_null(@$version->force_update) ? $version->force_update : 1, [
                'class' => 'form-control select2',
                'placeholder' => 'Paksa Update Aplikasi',
            ]) !!}
        </div>

        <div class="form-group col-sm-10">
            {!! Form::label('current_active', 'Status versi:') !!}
            {!! Form::select('current_active', [1 => 'Aktif', 0 => 'Tidak aktif'],  !is_null(@$version->current_active) ? $version->current_active : 0, [
                'class' => 'form-control select2',
                'placeholder' => 'Pilih Status Versi',
            ]) !!}
        </div>
    </div>
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('versions.index') !!}" class="btn btn-light">Cancel</a>
</div>
