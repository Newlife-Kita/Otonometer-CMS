<div class="row">
    <div class="col-sm-6">
        ...
        <div class="form-group col-sm-10">
            ...
            {!! Form::text('nama_lengkap', @$pejabatwilayah->nama_lengkap, ['class' => 'form-control']) !!}
        </div>

        <!-- Id Jabatan Field -->
        <div class="form-group col-sm-10">
            {!! Form::label('id_jabatan', 'Jabatan:') !!}
            {!! Form::select('id_jabatan', $masterjabatan, @$pejabatwilayah->id_jabatan, [
        ...
        @if (empty($pejabatwilayah))
            <div class="form-group col-sm-3">
                <div class="custom-control custom-checkbox">
                    {!! Form::checkbox('usetahun', 'y', null, ['class' => 'custom-control-input', 'id' => 'usetahun']) !!}
                    <label class="custom-control-label" for="usetahun">Single Tahun</label>
                </div>
            </div>

            <!-- Tahun Field -->
            <div class="form-group col-sm-3 d-none" id="tahun-box">
        ...
        @else
            ...
            <div class="form-group col-sm-3">
                {!! Form::label('tahun', 'Tahun:') !!}
                {!! Form::number('tahun', $pejabatwilayah->tahun ?? date('Y'), [
                    'class' => 'form-control date',
                    'required',
                    'min' => '1945',
                    'max' => date('Y'),
            ...
            <div class="form-group col-sm-8">
                {!! Form::label('periode', 'Periode:') !!}
                <div class="input-group mg-b-10">
                    {!! Form::number('tahun_lantik', $pejabatwilayah->tahun_lantik ?? date('Y'), [
                        'class' => 'form-control date',
                        'required',
                        'min' => '1945',
                        'max' => date('Y'),
                    ...
                    {!! Form::number('tahun_akhir', $pejabatwilayah->tahun_akhir ?? date('Y'), [
                        'class' => 'form-control date',
                        'required',
                        'min' => '1945',
                        'required',
    ...
    <div class="form-group col-xs-12 col-sm-3">
        ...
        {!! Form::file('foto', [
            ...
            'data-default-file' => @$pejabatwilayah->foto ? getFileUrl(@$pejabatwilayah->foto) : '',
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! @$back == 'pejabatwilayahs.preview_all' ? route('pejabatwilayahs.preview_all') : route(@$back ?? 'pejabatwilayahs.show', @$wilayah->id ?? '') !!}" class="btn btn-light">Cancel</a>
</div>
