...
@section('contents')
    <div class="content">
        <div class="container">
            ...
            <h4 id="section1" class="mg-b-10">Upload Data Wilayah</h4>
            ...
            <div style="margin-right: -15px;margin-left: -15px;">
                <div data-label="Create" class="df-example demo-forms services-forms">
                    ...
                    {!! Form::open(['route' => 'datawilayahs.store_excel', 'files' => true]) !!}
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <a href="{!! route('datawilayahs.template') !!}" class="btn btn-success"><i class="fa fa-download"></i>
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <a href="{!! route('datawilayahs.index') !!}" class="btn btn-light">Cancel</a>
                    </div>
                    {!! Form::close() !!}
                </div>
            </div>
