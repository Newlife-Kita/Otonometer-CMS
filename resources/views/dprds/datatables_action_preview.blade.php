{!! Form::open(['route' => ['dprds.preview_delete', $id], 'method' => 'delete', 'id' => 'table-form-' . $id]) !!}
<div class='btn-group'>
    @can('dprd-edit')
        <a href="{{ route('dprds.edit_preview', $id) }}" class='btn btn-outline-primary btn-xs btn-icon'>
