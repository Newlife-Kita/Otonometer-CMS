...
<div class="form-group col-sm-6">
    ...
    {!! Form::number('id_paket', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-6">
    ...
    {!! Form::date('tanggal_mulai', null, ['class' => 'form-control date']) !!}
</div>

<!-- Tanggal Akhir Field -->
<div class="form-group col-sm-6">
    {!! Form::label('tanggal_akhir', 'Tanggal Akhir:') !!}
    {!! Form::date('tanggal_akhir', null, ['class' => 'form-control date']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('memberpakets.index') !!}" class="btn btn-light">Cancel</a>
</div>
