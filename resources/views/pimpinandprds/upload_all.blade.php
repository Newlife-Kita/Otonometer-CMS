...
@section('contents')
    <div class="content">
        <div class="container">
            ...
            <h4 id="section1" class="mg-b-10">Upload Data Pimpinan DPRD Untuk Seluruh Wilayah.</h4>
            ...
            <div style="margin-right: -15px;margin-left: -15px;">
                <div data-label="Create" class="df-example demo-forms services-forms">
                    ...
                    {!! Form::open(['route' => ['pimpinandprds.store_excel_all'], 'files' => true]) !!}
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <a href="{!! route('pimpinandprds.template_all') !!}" class="btn btn-success"><i class="fa fa-download"></i>
