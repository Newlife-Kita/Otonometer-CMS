...
@section('contents')
    <div class="content content-components">
        <div class="container">
            ...
            <h4 class="mg-b-10">Preview Upload Data DPRD {!! strtoupper(@$wilayah->tipe) !!} - {!! @$wilayah->nama !!}</h4>
            ...
            <div class="d-md-block">
                @can('pejabatwilayah-delete')
                    {!! Form::open([
                        'route' => ['pimpinandprds.cancel', $wilayah->id],
                        'method' => 'delete',
                        'id' => 'cancel',
                        'class' => 'form-inline',
                    ]) !!}
                ...
                @can('pejabatwilayah-create')
                    {!! Form::open([
                        'route' => ['pimpinandprds.submit', $wilayah->id],
                        'id' => 'save-data',
                        'class' => 'form-inline',
                    ]) !!}
