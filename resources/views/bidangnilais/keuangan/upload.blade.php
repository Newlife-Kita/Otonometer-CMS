...
@section('contents')
    <div class="content">
        <div class="container">
            ...
            <h4 id="section1" class="mg-b-10">Upload Nilai Sektor/Bidang Keuangan</h4>

            <p class="mg-b-30">Please, fill all required fields before click save button.</p>

            <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
                <a href="{!! route('data-keuangan.index') !!}" class="btn btn-light"><i class="fas fa-chevron-left"></i> Back To List </a>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
            <div class="modal-content tx-14">
                <div class="modal-header">
                    <h6 class="modal-title" id="exampleModalLabel3">Upload File Excel Keuangan</h6>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                {!! Form::open(['route' => 'data-keuangan.upload', 'id' => 'formupload', 'files' => true]) !!}
...
@section('scripts')
    ...
    <script>
        ...
        @if (session()->has('checksum-keuangan'))

            @php
                $checksum = session('checksum-keuangan');
            @endphp
            ...
            $(document).ready(function() {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = "{!! route('data-keuangan.downloadUpload') !!}";
                    }
                });
            });
            ...
            @php
                session()->forget('checksum-keuangan');
            @endphp
        @endif
        ...
        $(document).on('click', '.btn-publish', function() {
            ...
            if (tahun > 0) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{!! route('data-keuangan.publish') !!}",
                            method: "post",
                            data: {
                                _token: '{!! csrf_token() !!}',
                                tahun_data: tahun,
                                ...
                                if (result.valid == true) {
                                    Swal.fire({
                                        ...
                                        html: "<p>Data terpublish : " + result.data
                                            ...
                                            .data_terganti + "</p><p>Data terinput : " +
                                    ...
                                    Swal.fire({
                                        ...
                                        if (result.isConfirmed) {
                                            $.ajax({
                                                url: "{!! route('data-keuangan.publish') !!}?force=" +
                                                    (result.value == "force" ?
                                                        'true' : 'false'),
                                                method: "post",
                                                data: {
        ...
        $(function() {
            $(document).on('click', '.btn-truncate', function(e) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{!! route('data-keuangan.deleteUpload') !!}",
                            method: "post",
                            data: {
                                _token: '{!! csrf_token() !!}',
                            },
