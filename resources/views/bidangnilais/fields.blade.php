...
<div class="form-group col-sm-6">
    {!! Form::label('id_bidang', 'Id Bidang:') !!}
    {!! Form::number('id_bidang', null, ['class' => 'form-control']) !!}
</div>
...
<!-- Nilai Field -->
<div class="form-group col-sm-6">
    {!! Form::label('nilai', 'Nilai:', ['class' => 'd-block']) !!}
...
<div class="form-group col-sm-6">
    ...
    {!! Form::date('tahun', null, ['class' => 'form-control date']) !!}
</div>
