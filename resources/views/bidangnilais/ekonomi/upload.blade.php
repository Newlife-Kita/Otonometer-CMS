...
@section('contents')
    <div class="content">
        <div class="container">
            ...
            <h4 id="section1" class="mg-b-10">Upload Nilai Sektor/Bidang Ekonomi</h4>

            <p class="mg-b-30">Please, fill all required fields before click save button.</p>

            <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
                <a href="{!! route('data-ekonomi.index') !!}" class="btn btn-light"><i class="fas fa-chevron-left"></i> Back To List </a>
            ...
            <div>
                <div class="alert alert-primary" role="alert">
                    <h5 class="alert-heading">Publish Data Ekonomi By Upload!</h5>
                    <hr>
                    <p class="mb-0">
                    <ol>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
            <div class="modal-content tx-14">
                <div class="modal-header">
                    <h6 class="modal-title" id="exampleModalLabel3">Upload File Excel Ekonomi</h6>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                {!! Form::open(['route' => 'data-ekonomi.upload', 'id' => 'formupload', 'files' => true]) !!}
...
@section('scripts')
    ...
    <script>
        ...
        @if (session()->has('checksum-ekonomi'))

            @php
                $checksum = session('checksum-ekonomi');
            @endphp
            ...
            $(document).ready(function() {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = "{!! route('data-ekonomi.downloadUpload') !!}";
                    }
                });
            });
            ...
            @php
                session()->forget('checksum-ekonomi');
            @endphp
        @endif
        ...
        $(document).on('click', '.btn-publish', function() {
            ...
            if (tahun > 0) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{!! route('data-ekonomi.publish') !!}",
                            method: "post",
                            data: {
                                _token: '{!! csrf_token() !!}',
                                tahun_data: tahun,
                            ...
                            success: function(result) {
                                if (result.valid == true) {
                                    ...
                                    Swal.fire({
                                        ...
                                        if (result.isConfirmed) {
                                            $.ajax({
                                                url: "{!! route('data-ekonomi.publish') !!}?force=" +
                                                    (result.value == "force" ?
                                                        'true' : 'false'),
                                                method: "post",
                                                data: {
                                ...
                                $(".btn-publish").prop('disabled', false).html(
                                    `<i class="fas fa-disc"></i> Publish Data`);
                            },
                            error: function($result) {
                                Swal.fire({
        ...
        $(function() {
            $(document).on('click', '.btn-truncate', function(e) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{!! route('data-ekonomi.deleteUpload') !!}",
                            method: "post",
                            data: {
                                _token: '{!! csrf_token() !!}',
                            },
