                ...
                <div>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Sektor/Bidang Ekonomi</li>
                        </ol>
                    </nav>
                </div>
            </div>

            <h4 class="mg-b-20">Sektor/Bidang Ekonomi</h4>
            <hr>
            ...
            <table class="table table-striped table-hover">
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th colspan="2">
                            @can('bidang-create')
                                <a class="btn btn-icon btn-primary btn-xs" href="{!! route('sektor-bidang.ekonomi.create', @$code) !!}"><i
                    ...
                    @foreach ($bidang as $bid)
                        <tr class="{{ $bid['cls_str'] }}" id="tr-{{ $bid['id'] }}">
                            ...
                            <td>
                                <div class="btn-group">
                                    @can('bidang-create')
                                        <a class="btn btn-icon btn-outline-primary btn-xs" href="{!! route('sektor-bidang.ekonomi.create', @$bid['id']) !!}"><i
                                                class="fa fa-plus"></i></a>
                                    @endcan
                                    @can('bidang-edit')
                                        <a href="{{ route('sektor-bidang.ekonomi.edit', $bid['id']) }}"
                                    ...
                                    @can('bidang-delete')
                                        {!! Form::open([
                                            'route' => ['sektor-bidang.ekonomi.destroy', $bid['id']],
                                            'method' => 'delete',
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $.ajax({
                url: "{!! route('sektor-bidang.check-tree', 2) !!}",
                method: 'GET',
                dataType: 'json',
