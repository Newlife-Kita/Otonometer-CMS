    ...
    <div class="content">
        <div class="container">
            ...
            <div style="margin-right: -15px;margin-left: -15px;">
                ...
                {!! Form::model($bidang, ['route' => ['bidangs.update', $bidang->id], 'method' => 'patch']) !!}
                <!-- Kode Field -->
                ...
                <!-- Tahun Nomenklatur Field -->
                <div class="form-group col-sm-2 bg-gray-200">
                    {!! Form::label('tahun_nomenklatur', 'Tahun Nomenklatur:', ['class' => 'pd-t-10 d-block']) !!}
                    @if (count($tahun) > 0)
                        <table class="table">
                            <tr>
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        {!! Form::checkbox('tahun_all', 'all', false, [
                                            'class' => 'custom-control-input',
                                            'id' => 'checkAll',
                                        ]) !!}
                                        <label class="custom-control-label" for="checkAll">Semua Tahun</label>
                                    </div>
                                </td>
                            </tr>
                            @foreach ($tahun as $y)
                                <tr>
                                    <td>
                                        <div class="custom-control custom-checkbox">
                                            {!! Form::checkbox('tahun_nomenklatur[]', $y, in_array($y, $bidang->tahun_nomenklatur) ? true : false, [
                                                'class' => 'custom-control-input check-row',
                                                'id' => 'customCheck_' . $loop->iteration,
                                            ]) !!}
                                            <label class="custom-control-label"
                                                for="customCheck_{{ $loop->iteration }}">Tahun {{ $y }}</label>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.check-row', function() {
                ...
                if (checked > 0) $(".check-row").prop('required', false);
                else $(".check-row").prop('required', true);
