...
<div class="form-group col-sm-6">
    ...
    @foreach($bahasa as $lg)
        ...
        <div class="input-group">
            ...
            {!! Form::text('nama['.$lg->code.']', (!empty($komisi->nama) ? $komisi->getTranslation('nama', $lg->code) : null), ['class' => 'form-control', 'required']) !!}
        </div> 
    @endforeach
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('komisis.index') !!}" class="btn btn-light">Cancel</a>
</div>
