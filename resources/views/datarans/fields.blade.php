        ...
        <div class="form-group col-sm-10">
            ...
            @foreach ($bahasa as $lg)
                ...
                <div class="input-group">
                    ...
                    {!! Form::text(
                        'nama[' . $lg->code . ']',
                        !empty($dataran->nama) ? $dataran->getTranslation('nama', $lg->code) : null,
    ...
    <div class="col-sm-3">
        ...
        <div class="form-group col-sm-12 col-lg-12">
            ...
            {!! Form::file('icon_light_mode', [
                ...
                'data-default-file' => @$dataran->icon_light_mode ? getFileUrl(@$dataran->icon_light_mode) : '',
        ...
        <div class="form-group col-sm-12 col-lg-12">
            ...
            {!! Form::file('icon_dark_mode', [
                'class' => 'form-control dropify',
                'data-default-file' => @$dataran->icon_dark_mode ? getFileUrl($dataran->icon_dark_mode) : '',
                'data-max-file-size' => '2M',
            ]) !!}
        </div>
    </div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('datarans.index') !!}" class="btn btn-light">Cancel</a>
</div>
