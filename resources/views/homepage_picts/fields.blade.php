...
<!-- Link Light Mode Field -->
<div class="form-group col-sm-6">
    {!! Form::label('link_light_mode', 'Link Light Mode:', ['class' => 'd-block']) !!}
    {!! Form::file('link_light_mode', [
        'class' => 'form-control dropify',
        'data-default-file' => @$homepagePict->link_light_mode ? getFileUrl(@$homepagePict->link_light_mode) : '',
        'data-max-file-size' => '2M'
    ]) !!}
</div>

<!-- Link Dark Mode Field -->
<div class="form-group col-sm-6">
    {!! Form::label('link_dark_mode', 'Link Dark Mode:', ['class' => 'd-block']) !!}
    {!! Form::file('link_dark_mode', [
        'class' => 'form-control dropify',
        'data-default-file' => @$homepagePict->link_dark_mode ? getFileUrl(@$homepagePict->link_dark_mode) : '',
        'data-max-file-size' => '2M'
    ]) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('homepagePicts.index') !!}" class="btn btn-light">Cancel</a>
</div>
