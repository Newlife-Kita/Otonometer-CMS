...
@section('contents')
    <div class="content content-components">
        <div class="container">
            ...
            <h4 class="mg-b-10">Upload Data Suku Dinas</h4>

            <div class="align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
                <div class="d-md-block">
                    {!! Form::open(['route' => ['sudins.upload', 'id' => $id], 'files' => true]) !!}
                    <div class="row">
                        <div class="form-group col-sm-6">
                            <a href="{!! route('sudins.download') !!}" class="btn btn-success mg-t-30 btn-download"><i
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <a href="{!! route('sudins.show', $id) !!}" class="btn btn-light">Cancel</a>
                    </div>
                    {!! Form::close() !!}
                </div>
            </div>
