...
@section('contents')
    <div class="content content-components">
        <div class="container">
            ...
            <h4 class="mg-b-10">Preview Suku Dinas {{ $wilayah->nama }}</h4>

            <p class="mg-b-30">
                This is a list of your <code> uploaded suku dinas of {{ $wilayah->nama }}</code>, you
                can manage by clicking on action
                buttons in
                this table.
            </p>
            ...
            <div class="d-md-block">
                @can('pejabatwilayah-delete')
                    {!! Form::open([
                        'route' => ['sudins.cancel', $wilayah->id],
                        'method' => 'delete',
                        'id' => 'cancel',
                        'class' => 'form-inline',
                    ]) !!}
                ...
                @can('pejabatwilayah-create')
                    {!! Form::open([
                        'route' => ['sudins.submit', $wilayah->id],
                        'id' => 'save-data',
                        'class' => 'form-inline',
                    ]) !!}
                ...
                Swal.fire({
                    ...
                    if (file.value) {
                        ...
                        $.ajax({
                            ...
                            method: 'post',
                            url: `{{ route('sudins.img_upload', ['id' => ':id']) }}`
                                .replace(':id', id),
                            data: formData,
                            processData: false,
                            contentType: false,
