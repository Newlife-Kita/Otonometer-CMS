...
<div class="form-group col-sm-6">
    {!! Form::label("nama[$lg->code]", "Nama ($lg->label):", ['class' => 'd-block']) !!}
    {!! Form::text("nama[$lg->code]", isset($satuan) ? $satuan->getTranslation('nama', $lg->code) : '', ['class' => 'form-control']) !!}
</div>
@endforeach

<!-- Kategori Field -->
<div class="form-group col-sm-6">
    {!! Form::label('kategori', 'Kategori:', ['class' => 'd-block']) !!}
    {!! Form::select('kategori', ['' => 'Pilih Kategori', 'mean(v1)' => 'Rata-Rata Versi 1', 'total' => 'Total'], @$satuan->kategori, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('satuans.index') !!}" class="btn btn-light">Cancel</a>
</div>
