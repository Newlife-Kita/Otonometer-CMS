    ...
    return (function (e) {
                    ...
                    onInput: function (e) {
                        ...
                        return (
                            ...
                            r.phone
                                ...
                                : r.numeral
                                ? (!r.prefix || (r.noImmediatePrefix && !e.length) ? (r.result = r.numeralFormatter.format(e)) : (r.result = r.prefix + r.numeralFormatter.format(e)), void t.updateValueState())
                                : (r.date && (e = r.dateFormatter.getValidatedDate(e)),
                                  ...
                                  (e = n.getPrefixStrippedValue(e, r.prefix, r.prefixLength, r.result)),
                                  (e = r.numericOnly ? n.strip(e, /[^\d]/g) : e),
                                  (e = r.uppercase ? e.toUpperCase() : e),
                                  (e = r.lowercase ? e.toLowerCase() : e),
                                  !r.prefix || (r.noImmediatePrefix && !e.length) || ((e = r.prefix + e), 0 !== r.blocksLength)
                ...
                (r.prototype = {
                    ...
                    format: function (e) {
                        ...
                        switch (
                            ...
                            (i = e),
                            e.indexOf(n.numeralDecimalMark) >= 0 && ((t = e.split(n.numeralDecimalMark)), (i = t[0]), (a = n.numeralDecimalMark + t[1].slice(0, n.numeralDecimalScale))),
                            n.numeralIntegerScale > 0 && (i = i.slice(0, n.numeralIntegerScale + ("-" === e.slice(0, 1) ? 1 : 0))),
        ...
        function (e, t) {
            ...
            var r = {
                ...
                getPrefixStrippedValue: function (e, t, r, i) {
                    if (e.slice(0, r) !== t)
                        if (e.length < i.length) e = e.length > r ? i : t;
                        else {
