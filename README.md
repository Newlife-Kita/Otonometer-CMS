...
* Using Git
        ...
        git clone https://dev.redtech.co.id/ict-redtech/webcore-10.git
...
Default users are
    ...
    with default password is redtech.co.id
...
#### run these artisan commands in your console
    ...
    php artisan generate:api_scaffold Page --fieldsFile=Page.json --datatables=true --prefix=webcore --logs

    php artisan generate:api_scaffold Post --fieldsFile=Post.json --datatables=true --prefix=webcore --logs
